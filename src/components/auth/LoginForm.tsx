...
export const LoginForm: React.FC = () => {
  ...
  return (
    <div className="fixed-full flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 px-4 sm:px-6 lg:px-8">
